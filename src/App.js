  ...
  return (
    <body className='page-LikeDeslike'>
      ...
      <div className='props'>
        ...
        <Funcionario imgURL="https://noticias.maisesports.com.br/wp-content/uploads/2023/03/52775095012_364a6b847d_k.jpg" nomeFunc="tayhuhu" codigoFuncionario="123" like={curtida}/>
      </div>
